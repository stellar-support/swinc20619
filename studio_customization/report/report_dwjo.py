    ...
    def _select(self):
        ...
        select_str = """
            with dwjo as (
                                ...
                                sum (case
                                        when i.invoice_date > current_date - interval '6 months' then ail.quantity
                                        else 0
                                    end) as quantity_6,
                                sum (case
                                        when i.invoice_date > current_date - interval '2 months' then ail.quantity
                                        else 0
                                    end) as quantity_2,
                                sum (case
                                        when i.invoice_date > current_date - interval '1 months' then ail.quantity
                                        else 0
                                    end) as quantity_1,
                                sum (case
                                        when i.invoice_date > current_date - interval '2 weeks' then ail.quantity
                                        else 0
                                    end) as quantity,
                                0 as qty_hand,
                                0 as qty_order,
                                ...
                                inner join account_move as i on i.id = ail.move_id
